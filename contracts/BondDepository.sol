...
contract BondDepository is Ownable {
    ...
    struct Bond {
        uint payout; // Tulip remaining to be paid
    ...
    function deposit( 
        ...
        uint balanceBefore = Tulip.balanceOf(address(this));
        /**
        ...
        require(balanceBefore.add(profit) == Tulip.balanceOf(address(this)), "Not enough Tulip to cover profit");
